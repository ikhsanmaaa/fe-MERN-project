          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <div>
              ...
              <Skeleton
                ...
                className="h-4 rounded-md"
              >
                <p className="text-sm">{`${dataTickets?.name} (${dataTickets?.price})x${dataOrder?.quantity}`}</p>
              </Skeleton>
            </div>
            <div>
              ...
              <Skeleton
                ...
                className="h-4 rounded-md"
              >
                <p className="text-sm">{convertIDR(dataOrder?.total)}</p>
              </Skeleton>
            </div>
            <div>
              ...
              {dataOrder?.vouchers.map((voucher: { voucherId: string }) => (
                ...
                >
                  <CardBody className="gap-8 lg:flex-row">
                    <div className="mx-auto w-2/3 mb-4 lg:m-0 lg:w-1/5">
                      <QRCodeSVG
